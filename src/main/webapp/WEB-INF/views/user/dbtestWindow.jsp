...
<script>
  ...
  function wClose() {
	...
	function idCheck() {
		let mid = childForm.mid.value.trim();
...
<h3>아이디 중복체크</h3>
  ...
  <div class="text-center">
  	<c:if test="${idCheck == 'OK'}"><font color="red"><b>${mid}는 사용가능한 아이디입니다</b></font></c:if>
  	<c:if test="${idCheck != 'OK'}">
  		<font color="red"><b>${mid}는 이미 사용중인 아이디입니다 다시 검색하세요</b></font>
