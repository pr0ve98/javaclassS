...
<head>
  ...
  <script>
    ...
    $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&appid=aea6ea90a060e2d45a22e00db00cdbd6&units=metric',
    ...
    function weatherCheck2() {
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+position.coords.latitude+'&lon='+position.coords.longitude+'&appid=aea6ea90a060e2d45a22e00db00cdbd6&units=metric',
  	    function (WeatherResult) {
	    	$(".dispForm2").show();
    ...
    function weatherCheck3() {
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+positionObj.latitude+'&lon='+positionObj.longitude+'&appid=aea6ea90a060e2d45a22e00db00cdbd6&units=metric',
  	    function (WeatherResult) {
	    	  $(".dispForm3").show();
