		...
		<tr>
			...
			<td class="text-right">
				<select name="pageSize" id="pageSize" onchange="pageSizeCheck()">
					...
					<option value="10" ${pageVO.pageSize==10 ? "selected" : ""}>10개씩 보기</option>
					<option value="20" ${pageVO.pageSize==20 ? "selected" : ""}>20개씩 보기</option>
					<option value="30" ${pageVO.pageSize==30 ? "selected" : ""}>30개씩 보기</option>
				</select>
			</td>
		</tr>
	</table>
